<template>
  <div>
    <section class="page-header">
      ...
      <a href="https://github.com/lcj947993447/gridsome-blog"
         class="btn"
         target="_blank"
         v-if="!mini">博客源码</a>
    </section>
...
export default {
  ...
  data () {
    return {
      githubUsername: 'lcj947993447',
      blogTitle: 'lxga',
      blogDescribe: 'lxga的博客',
      mini: false,
      webSites: '',
      avatarUrl: {
        url: 'https://avatars0.githubusercontent.com/u/19698962?s=460&u=8ed90813d7a8d96c57ea179802c3751a8dae62e8&v=4',
      },
      location: '中国 上海市',
      name: '',
      fullButton: {
      ...
      switch (index)
      {
        ...
        default:
          if (/#webSites-\d+/.test(index))
          {
            ...
            let url = this.webSites.split(',')[i].url
